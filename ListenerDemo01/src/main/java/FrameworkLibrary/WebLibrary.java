...
*/
	...
	/**	
 	* 	Description			: Used Launch Browser 
	*	Method Name			: launchBrowser
	*	Input parameters	: 1)  Browser Name to launch 
	*	Created By			: bhaskar
	*	Created On			: 8-May-2017 
	*	LastUpdated On		: 9-Sep-2018 
	*	Last Updated By		:  
	*	Email id			:  
	*	Comments			: @return -- WebDriver
	*/	
...
/**	
 	* 	Description			: to open the URL in the driver instance
	*	Method Name			: OpenUrl
	*	Input parameters	: 1) URL 
	*						  2) driver instance
	*	Created By			: bhaskar
	*	Last Updated By		: bhaskar 
	*/
	...
	/**	
 	* 	Description			: to close all window instances
	...
	*/
	...
	/**	
 	* 	Description			: to varify the existance of a webelement
	*	Method Name			: exists
	*	Input parameters	: 1)  driver instance
	*	Created By			: bhaskar
	*	Created On			: 8-May-2017 
...
/**	
 	* 	Description			: set Text in elemwnt And press Escape
...
/**		
 	* 	Description			: To perform mouse hover to a element
...
/**		Description			: To perform right click on  a element
...
/**		Description			: To perform dragAndDrop action on an element
...
/**		Description			: To switch to a frame based on element 
	...
	*	LastUpdated On		: 9-May-2017 
	*	Last Updated By		: bhaskar
	*	Email id			: balreddy. ankireddy@wellsfargo.com
	*	Comments			:
*/
...
/**		Description			: To switch to a frame based on title 
	*	Method Name			: switchToTitle 
	*	Input parameters	: 1)  frame Xpath
	*						  2)  driver instance
	*	Created By			: bhaskar
	*	Created On			: 8-May-2017 
...
/**		Description			: To switch to window based on URL
...
/**		Description			: To close a window based on URL xx
	*	Method Name			: closeWindowByURL
	*	Input parameters	: 1)  window URL
	*						  2)  driver instance
	*	Created By			: bhaskar
...
/**	
* 	Description			: to verify if Alert Exists
*	Method Name			: AlertExists 
*	Input parameters	: 1)  driver instance 
*	Created By			: bhaskar
*	Created On			: 8-May-2017 
*	LastUpdated On		: 9-Sep-2018 
...
public static void logEvent(boolean stepStatus,String plog,String flog, WebDriver driver,boolean flagTakeScreenshot)
{
...
/**
 * 	Description			: get current Date and TimeStamp in the form of String 
...
/**
* 	Description			: get getNewRelationShipName with current Date and TimeStamp in the form of String 
*	Method Name			: getNewRelationShipName 
*	Input parameters	: 1)	StepStatus
*						  2)	Pass Log Message
*						  3) 	Fail Log Message
*						  4)    driver instance
...
/**
* 	Description			: take screenshot of current driver instance
...
/**
 * 	Description			: Used to click on a webelement
*	Method Name			: jsClickElement
*	Input parameters	: (1) WebElement (2) WebDriver
*	Created By			: bhaskar
*	Created On			: 8-May-2017 
*	LastUpdated On		: 9-May-2017 
*	Last Updated By		: bhaskar
*	Email id			:  
*	Comments			: @return -- True/False
*/
